...
![[20240924_chatbot_diagram.png|동작 다이어그램]]
_동작 다이어그램_
...
### 발화 처리
- 사용자 발화(utterance)는 카카오톡 챗봇의 [블록](https://kakaobusiness.gitbook.io/main/tool/chatbot/main_notions/block)으로 유입되고 블록에서 미리 정해진 대로 처리됨
