...
ChatGPT 를 필두로 LLM 이 우리의 삶에 조금씩 녹아들면서, 개발자들의 업무 방식에도 변화가 많이 생겼다. 그 중에서 가장 큰 변화는 구글 검색 빈도가 낮아지는 게 아닐까 싶다.
